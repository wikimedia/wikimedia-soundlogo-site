...
export default function VisualEditor({
  ...
  const ref = useRef();
  const contentRef = useMergeRefs([ref, useClipboardHandler(), useCanvasClickRedirect(), useTypewriter(), useTypingObserver(), useBlockSelectionClearer()]);
  const blockSelectionClearerRef = useBlockSelectionClearer();
  const [, RecursionProvider] = useNoRecursiveRenders(wrapperUniqueId, wrapperBlockName);
  ...
  }, themeSupportsLayout && !isTemplateMode && createElement(LayoutStyle, {
