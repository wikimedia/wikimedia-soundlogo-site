...
import { TableOfContents, EditorHistoryRedo, EditorHistoryUndo, store as editorStore } from '@wordpress/editor';
...
function HeaderToolbar() {
  ...
  return createElement(NavigableToolbar, {
    ...
    showTooltip: !showIconLabels
  }, showIconLabels && (!isInserterOpened ? __('Add') : __('Close'))), (isWideViewport || !showIconLabels) && createElement(Fragment, null, isLargeViewport && createElement(ToolbarItem, {
    as: ToolSelector,
    showTooltip: !showIconLabels,
    variant: showIconLabels ? 'tertiary' : undefined,
    disabled: isTextModeEnabled
