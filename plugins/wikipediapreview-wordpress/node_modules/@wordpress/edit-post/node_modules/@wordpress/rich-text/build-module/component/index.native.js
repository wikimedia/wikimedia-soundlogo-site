...
export class RichText extends Component {
  ...
  shouldComponentUpdate(nextProps) {
    ...
    if (!this.comesFromAztec) {
      var _nextProps$style, _this$props, _this$props$style, _nextProps$style2, _this$props2, _this$props2$style;
      ...
      if ((nextProps === null || nextProps === void 0 ? void 0 : (_nextProps$style = nextProps.style) === null || _nextProps$style === void 0 ? void 0 : _nextProps$style.fontSize) !== ((_this$props = this.props) === null || _this$props === void 0 ? void 0 : (_this$props$style = _this$props.style) === null || _this$props$style === void 0 ? void 0 : _this$props$style.fontSize) || (nextProps === null || nextProps === void 0 ? void 0 : (_nextProps$style2 = nextProps.style) === null || _nextProps$style2 === void 0 ? void 0 : _nextProps$style2.lineHeight) !== ((_this$props2 = this.props) === null || _this$props2 === void 0 ? void 0 : (_this$props2$style = _this$props2.style) === null || _this$props2$style === void 0 ? void 0 : _this$props2$style.lineHeight)) {
        this.needsSelectionUpdate = true;
        this.manipulateEventCounterToForceNativeToRefresh(); // force a refresh on the native side
      }
    }
  ...
  getFontSize() {
    var _baseGlobalStyles$typ, _this$props$style2;
    ...
    if ((_this$props$style2 = this.props.style) !== null && _this$props$style2 !== void 0 && _this$props$style2.fontSize) {
  ...
  getLineHeight() {
    var _baseGlobalStyles$typ3, _this$props$style3;
    ...
    if ((_this$props$style3 = this.props.style) !== null && _this$props$style3 !== void 0 && _this$props$style3.lineHeight) {
