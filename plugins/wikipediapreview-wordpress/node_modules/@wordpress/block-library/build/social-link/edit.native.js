...
const SocialLinkEdit = ({
  ...
  const activeIcon = _editor.default[`wp-social-link-${service}`] || _editor.default[`wp-social-link`];
  const inactiveIcon = (0, _compose.usePreferredColorSchemeStyle)(_editor.default.inactiveIcon, _editor.default.inactiveIconDark);
  ...
  const socialLinkName = (0, _socialList.getNameBySite)(service); // When new social icon is added link sheet is opened automatically
  ...
  const accessibilityHint = url ? (0, _i18n.sprintf)( // translators: %s: social link name e.g: "Instagram".
