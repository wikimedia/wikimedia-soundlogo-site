...
function CodeEdit(props) {
  ...
  const codeStyle = getStylesFromColorScheme(_theme.default.blockCode, _theme.default.blockCodeDark);
  const placeholderStyle = getStylesFromColorScheme(_theme.default.placeholder, _theme.default.placeholderDark);
