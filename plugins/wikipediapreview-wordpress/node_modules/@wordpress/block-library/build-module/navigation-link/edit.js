...
import { PanelBody, Popover, TextControl, TextareaControl, ToolbarButton, Tooltip, ToolbarGroup } from '@wordpress/components';
import { displayShortcut, isKeyboardEvent, ENTER } from '@wordpress/keycodes';
import { __, sprintf } from '@wordpress/i18n';
import { BlockControls, InspectorControls, RichText, __experimentalLinkControl as LinkControl, useBlockProps, store as blockEditorStore, getColorClassName } from '@wordpress/block-editor';
...
export default function NavigationLinkEdit({
  ...
  const {
    ...
    return {
      ...
      isAtMaxNesting: getBlockParentsByBlockName(clientId, [name, 'core/navigation-submenu']).length >= MAX_NESTING,
  ...
  const classes = classnames('wp-block-navigation-link__content', 'wp-block-navigation-item__content', {
