...
export const getEmbedInfoByProvider = provider => {
  ...
  return (_getBlockVariations = getBlockVariations(DEFAULT_EMBED_BLOCK)) === null || _getBlockVariations === void 0 ? void 0 : _getBlockVariations.find(({
    name
  }) => name === provider);
};
/**
...
export const findMoreSuitableBlock = url => {
  ...
  return (_getBlockVariations2 = getBlockVariations(DEFAULT_EMBED_BLOCK)) === null || _getBlockVariations2 === void 0 ? void 0 : _getBlockVariations2.find(({
    patterns
...
export const createUpgradedEmbedBlock = (props, attributesFromPreview = {}) => {
  ...
  const wpVariation = (_getBlockVariations3 = getBlockVariations(DEFAULT_EMBED_BLOCK)) === null || _getBlockVariations3 === void 0 ? void 0 : _getBlockVariations3.find(({
    name
