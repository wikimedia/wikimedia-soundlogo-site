...
import { BaseControl, PanelBody, SelectControl, ToggleControl, withNotices, RangeControl, Spinner } from '@wordpress/components';
import { store as blockEditorStore, MediaPlaceholder, InspectorControls, useBlockProps } from '@wordpress/block-editor';
...
function GalleryEdit(props) {
  ...
  function updateImages(selectedImages) {
    ...
    if (!imageArray.every(isValidFileType)) {
      ...
      noticeOperations.createErrorNotice(__('If uploading to a gallery all files need to be image formats'), {
    ...
    replaceInnerBlocks(clientId, concat(existingImageBlocks, newBlocks).sort((a, b) => newOrderMap[a.attributes.id] - newOrderMap[b.attributes.id]));
  }
  ...
  return createElement(Fragment, null, createElement(InspectorControls, null, createElement(PanelBody, {
    ...
    hideCancelButton: true
  }), Platform.isWeb && !imageSizeOptions && createElement(BaseControl, {
    className: 'gallery-image-sizes'
  }, createElement(BaseControl.VisualLabel, null, __('Image size')), createElement(View, {
    className: 'gallery-image-sizes__loading'
  }, createElement(Spinner, null), __('Loading options…'))))), noticeUI, createElement(Gallery, _extends({}, props, {
    images: images,
