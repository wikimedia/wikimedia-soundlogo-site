...
export default function TemplatePartPlaceholder({
  ...
  const onCreate = useCallback(async (startingBlocks = [], title = __('Untitled Template Part')) => {
  ...
  return createElement(Fragment, null, step === PLACEHOLDER_STEPS.initial && createElement(Placeholder, {
    ...
    'Choose an existing %s or create a new one.', areaLabel.toLowerCase()) : sprintf( // Translators: %s as template part area title ("Header", "Footer", etc.).
    ...
    renderToggle: ({
      isOpen,
      onToggle
    }) => createElement(Fragment, null, enableSelection && createElement(Button, {
      variant: "primary",
      onClick: onToggle,
