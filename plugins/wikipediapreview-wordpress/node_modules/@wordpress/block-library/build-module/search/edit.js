...
import { useBlockProps, BlockControls, InspectorControls, RichText, __experimentalUseBorderProps as useBorderProps, __experimentalUnitControl as UnitControl, __experimentalUseColorProps as useColorProps } from '@wordpress/block-editor';
...
export default function SearchEdit({
  ...
  const renderTextField = () => {
    ...
    const textFieldClasses = classnames('wp-block-search__input', isButtonPositionInside ? undefined : borderProps.className);
