...
import { Button, PanelBody, Placeholder, TextControl, ToggleControl, ToolbarDropdownMenu } from '@wordpress/components';
...
function TableEdit({
  ...
  return createElement("figure", useBlockProps(), !isEmpty && createElement(Fragment, null, createElement(BlockControls, {
    group: "block"
