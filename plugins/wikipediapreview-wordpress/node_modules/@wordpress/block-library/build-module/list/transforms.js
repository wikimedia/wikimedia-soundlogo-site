...
const transforms = {
  from: [{
    ...
    transform: blockAttributes => {
      return createBlock('core/list', {
        values: toHTMLString({
          value: join(blockAttributes.map(({
            content
          }) => {
            const value = create({
              html: content
    ...
    transform(node) {
      ...
      return createBlock('core/list', { ...getBlockAttributes('core/list', node.outerHTML),
        ...attributes
      });
    }
  ...
  to: [{
    ...
    }), __UNSTABLE_LINE_SEPARATOR).map(piece => createBlock('core/paragraph', {
    ...
    transform: ({
      ...
      multilineTag: 'li',
      multilineWrapperTags: ['ul', 'ol']
    }), __UNSTABLE_LINE_SEPARATOR).map(piece => createBlock('core/heading', {
      content: toHTMLString({
        value: piece
      })
    }))
