...
import { __experimentalUseInnerBlocksProps as useInnerBlocksProps, InspectorControls, JustifyToolbar, BlockControls, useBlockProps, store as blockEditorStore, withColors, PanelColorSettings, ContrastChecker, getColorClassName } from '@wordpress/block-editor';
...
function Navigation({
  ...
  const placeholder = useMemo(() => createElement(PlaceholderPreview, null), []); // When the block is selected itself or has a top level item selected that
  ...
  if (isPlaceholderShown) {
    ...
    return createElement("div", blockProps, createElement(PlaceholderComponent, {
  ...
  }), !attributes.openSubmenusOnClick && createElement(ToggleControl, {
