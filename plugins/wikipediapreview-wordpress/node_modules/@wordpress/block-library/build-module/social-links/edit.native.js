...
const ALLOWED_BLOCKS = variations.map(v => `core/social-link-${v.name}`); // Template contains the links that show when start.
...
function SocialLinksEdit({
  ...
  const renderFooterAppender = useRef(() => createElement(View, null, createElement(InnerBlocks.ButtonBlockAppender, {
    isFloating: true
  })));
