...
const migrateCustomColorsAndFontSizes = attributes => {
  ...
  return { ...omit(attributes, ['customTextColor', 'customBackgroundColor', 'customFontSize']),
    style
  };
};
...
const deprecated = [{
  supports,
  attributes: { ...omit(blockAttributes, ['style']),
    customTextColor: {
      type: 'string'
    },
  ...
  migrate(attributes) {
    return migrateCustomColorsAndFontSizes(omit({ ...attributes,
