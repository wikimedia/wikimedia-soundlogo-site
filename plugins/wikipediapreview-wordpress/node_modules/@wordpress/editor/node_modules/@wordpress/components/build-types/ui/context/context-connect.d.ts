 ...
 */
export function contextConnect<P extends import("./wordpress-component").WordPressComponentProps<{}, any, any>>(Component: (props: P, ref: import('react').Ref<any>) => JSX.Element | null, namespace: string, options?: {
    memo?: boolean | undefined;
}): import("./wordpress-component").WordPressComponentFromProps<P>;
/**
