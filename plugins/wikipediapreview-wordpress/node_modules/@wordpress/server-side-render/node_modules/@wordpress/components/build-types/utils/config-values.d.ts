declare namespace _default {
    ...
    import toggleGroupControlBackdropBackgroundColor = controlSurfaceColor;
    export { toggleGroupControlBackdropBackgroundColor };
    export const toggleGroupControlBackdropBorderColor: string;
    export const toggleGroupControlBackdropBoxShadow: string;
