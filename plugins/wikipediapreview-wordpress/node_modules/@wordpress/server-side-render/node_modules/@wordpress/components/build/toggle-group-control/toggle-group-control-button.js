...
function ToggleGroupControlButton({
  ...
  return (0, _element.createElement)(LabelView, {
  ...
  }, (0, _element.createElement)(_reakit.Radio, (0, _extends2.default)({}, props, {
    as: "button",
    "aria-label": label,
    className: classes,
    "data-value": value,
    ...
    "aria-hidden": true
  }, label)), (0, _element.createElement)(ToggleGroupControlSeparator, {
    isActive: !showSeparator
  }));
}

const ToggleGroupControlSeparator = (0, _element.memo)(({
  isActive
}) => {
  const cx = (0, _hooks.useCx)();
  const classes = cx(isActive && styles.separatorActive);
  return (0, _element.createElement)(SeparatorView, {
    "aria-hidden": true,
    className: classes
  });
});

var _default = (0, _element.memo)(ToggleGroupControlButton);
